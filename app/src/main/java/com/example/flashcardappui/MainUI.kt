...
import com.example.flashcardappui.pages.FlashPage
import com.example.flashcardappui.pages.HomePage
import com.example.flashcardappui.pages.SettingPage
...
fun MainScreen() {
    ...
    val navList = listOf(
        ...
        NavItem("Flashcard", Icons.Default.Create),
